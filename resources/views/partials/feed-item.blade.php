    ...
    <div class="border-pixl-light/10 border-b pb-5">
      ...
      <div class="flex items-center justify-between gap-4">
        <div class="flex items-center gap-2.5">
          ...
          <p class="text-pixl-light/40 text-xs">{{ $item->posted_ago }}</p>
          <p>
            <a
      ...
      <div class="mt-6 flex items-center justify-between gap-4">
        <div class="flex items-center gap-8">
          ...
          <div class="flex items-center gap-1">
            ...
            <span class="text-sm">{{ $item->like_count }}</span>
          </div>
          <!-- Comment -->
          <div class="flex items-center gap-1">
            ...
            <span class="text-sm">{{ $item->reply_count }}</span>
          </div>
          <!-- Re-post -->
          <div class="flex items-center gap-1">
            ...
            <span class="text-sm">{{ $item->repost_count }}</span>
          </div>
        </div>
      ...
      <!-- Reply form -->
      <div class="border-pixl-light/10 bg-pixl-light/[3%] mt-8 border-t p-4">
        @include('partials.post-form', [
          'labelText' => 'Reply body',
          'fieldName' => 'reply',
          'placeholder' => "Reply to {$item->profile->display_name}'s post",
          'rows' => 5,
          'textareaClass' => 'w-full resize-none text-sm',
          'buttonClass' => 'bg-pixl/10 hover:bg-pixl/15 active:bg-pixl/20 text-pixl border border-transparent px-4 py-1 text-sm',
          'action' => '#',
        ])
      </div>
    </div>
