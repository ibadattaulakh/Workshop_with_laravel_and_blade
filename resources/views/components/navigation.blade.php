...
>
  <div class="overflow-y-auto">
    ...
    <nav class="mt-10">
      <ul class="flex flex-col gap-3.5">
        <li>
          <a 
            class="hover:underline {{ request()->routeIs('posts.index') ? 'font-semibold' : '' }}" 
            href="{{ route('posts.index') }}"
            @if(request()->routeIs('posts.index')) aria-current="page" @endif
          >
            Home
          </a>
        </li>
        ...
        @auth
          <li>
            <a class="hover:underline" href="{{ route('profiles.show', auth()->user()->profile->handle) }}">Profile</a>
          </li>
        @endauth
  ...
  @auth
    <div class="flex gap-3.5">
      <a href="{{ route('profiles.show', auth()->user()->profile->handle) }}" class="shrink-0">
        <img
