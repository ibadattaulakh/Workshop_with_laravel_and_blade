<form action="{{ route('posts.reply', ['profile' => $post->profile, 'post' => $post]) }}" method="POST" class="border-pixl-light/10 bg-pixl-light/[3%] mt-8 border-t p-4">
  @csrf

  <div class="flex items-start gap-4">
    <a href="{{ route('profiles.show', $profile->handle) }}" class="shrink-0">
      <img
